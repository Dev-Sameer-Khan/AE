    ...
    <div className="pt-24 pb-20 bg-white min-h-screen">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-slate-500 mb-8 overflow-x-auto whitespace-nowrap pb-2">
          ...
          <span className="text-[var(--color-navy)] font-medium truncate max-w-[200px] md:max-w-none">
                ...
                <div className="bg-slate-50 rounded-xl p-6 border border-slate-100">
                  <ul className="space-y-4">
                    {Object.entries(product.specs).map(([key, value]) => (
                      <li
                        key={key}
                        className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 last:border-0 last:pb-0"
                      >
                        <span className="text-slate-500 font-medium mb-1 sm:mb-0">
                          {key}
                        </span>
                        <span className="text-[var(--color-navy)] font-semibold text-right">
                          {value}
                        </span>
                      </li>
                    ))}
        ...
        >
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-[var(--color-navy)] mb-4">
              {language === "en" ? "Why Choose Us" : "منتجاتنا"}
            </h2>
            <div className="w-20 h-1 bg-[var(--color-orange)] mx-auto rounded-full mb-6" />
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              {language === "en"
                ? "E    Our commitment to quality, expertise, and customer support keeps your equipment running and downtime under control—no matter where you operate."
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-slate-50 rounded-2xl p-6 backdrop-blur-sm border border-slate-100 shadow hover:shadow-md transition-all duration-300 group"
            >
              <div className="w-16 h-16  mb-2 rounded-2xl group-hover:shadow-sm transition-all duration-300 mx-auto lg:mx-0 bg-white flex items-center justify-center text-[var(--color-orange)]">
                <ShieldCheck
                  className="group-hover:scale-125 transition-all duration-300"
                  size={36}
                />
              </div>
              <h3 className="text-2xl font-display font-semibold mb-2 text-center lg:text-left">
                Warranty Guaranteed
              </h3>
              <p className="text-slate-600 leading-relaxed text-[15px] text-center lg:text-left">
                Comprehensive warranty on critical components and OEM-grade
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-[15px] text-center lg:text-left">
                Every shipment is checked against strict specifications so your
                engines and compressors perform as designed.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-[15px] text-center lg:text-left">
                Application guidance, part identification, and after‑sales
                support from specialists who know your machines.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-[15px] text-center lg:text-left">
                Strategic sourcing across India, Gulf, and Turkey with fast
                dispatch on stocked items.
              </p>
            </motion.div>
          </div>
        </motion.section>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start mb-10">
              <div>
                ...
                <p className="text-lg text-slate-600 max-w-2xl">
                  Handpicked options from our catalog that match the performance
                  and application profile of this product.
                </p>
              </div>
              <Link
                to="/products"
          ...
          >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start mb-10">
              <div>
                ...
                <p className="text-lg text-slate-600 max-w-2xl">
                  Carefully selected alternatives from our catalog designed to offer comparable performance and fit for your needs.
                </p>
              </div>
              <Link
                to="/products"
            ...
            <p className="text-sm text-slate-500 mb-6">
              Explore more {product.category.toLowerCase()} from Ameera
              Enterprises.
            </p>
      ...
      >
        <div className="bg-white shadow-md border border-slate-200 overflow-hidden rounded-3xl px-6 py-8 md:px-10 md:py-10 text-[var(--color-navy)] flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl md:text-3xl font-display font-bold mb-3">
              Need more information?
            </h2>
            <p className="text-sm md:text-base max-w-xl">
              Share your questions with our team or chat on WhatsApp for quick
              clarifications on specifications, compatibility, and pricing.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[var(--color-orange)] border border-slate-200 text-white text-sm font-semibold hover:bg-[var(--color-orange-hover)] transition-colors w-full sm:w-auto"
            >
